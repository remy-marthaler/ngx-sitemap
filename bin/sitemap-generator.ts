...
<urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">`;
    ...
    process(): void {
        new Glob(this.srcDirectory + '/**/index.html', (err: Error, res: string[]) => this.filesCallback(err, res));
    }
    ...
    private writeSitemapToFile(): void {
        fs.writeFile(this.srcDirectory + 'sitemap.xml', this.SITEMAP_HEADER + this.sitemapContent + this.SITEMAP_FOOTER, (err: NodeJS.ErrnoException | null) => {
            if (err) {
